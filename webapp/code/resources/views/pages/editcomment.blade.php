...
@section('content')
    ...
    <section id="edit_comment_event">
        ...
        <form id="comment_form" method="POST" action="{{ route('comment.update', ['comment_id' => $comment_id, 'comment' => $comment]) }}">
            {{ csrf_field() }}
            <div class="form-group mt-3">
                <label for="comment">Please rewrite your message in this box...</label>
                <textarea id="comment" form="comment_form" name="comment_message" class="form-control" placeholder="{{ $comment -> messagec }}"
