            ...
            <div class=" m-2 p-2 border border-primary rounded">
                <div class="row">
                    ...
                    <div class="col d-flex justify-content-end">
                        <a class="btn btn-danger" href="{{ url('/report/'.$report->id.'/delete') }}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
